    ...
    >
      ...
      <div className="bg-[#f1f1f1]">
        <div className="justify-between md:py-6 py-4 md:grid grid-cols-5">
          <div className="item">
            ...
            <p className="px-4 text-justify">
              ...
              maiores dolorum nulla possimus cumque natus, culpa dicta obcaecati
              vel perspiciatis, repudiandae quae repellat beatae sint ipsam
              explicabo laudantium similique?
            </p>
          </div>
          <div className="item px-5 ">
            <div className="">
              ...
              <ul className="mt-6">
                <li className="hover:underline duration-500 text-gray-600 hover:text-black">
                  <a className="" href="/">
          ...
          <div className="item px-5 ">
            <div className="">
              ...
              <p>
                Language Assistance Available in: Español, 中文, 한국어,
                Português, ગુજરાતી, Polskie, Italiano, العربية, Việt, Français,
                اُردُو
              </p>
            </div>
          </div>
        ...
        <div className="w-10/12 md:flex justify-between items-center py-6 mx-auto">
          <div className="social">
            <ul className="flex gap-2">
              <li className="w-8 h-8 rounded-full border-2 border-black flex justify-center items-center">
                <a
                  className="hover:text-black text-gray-500 w-fit duration-300"
                  href="/"
                >
          ...
          <p className="py-4 text-md text-gray-400 px-4">
            Copyright all reserve By Toriqul Islam
          </p>
        </div>
      </div>
    </div>
